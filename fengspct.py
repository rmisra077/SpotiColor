# Taken from fengsp on Github
# Code can be found at https://github.com/fengsp/color-thief-py/blob/master/colorthief.py
# Color Thief - finds most dominant color in image
